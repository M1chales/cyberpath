...
export default function Terms() {
  const [summary, ...sections] = TERMS_SECTIONS
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <p className="mt-10 text-xs text-slate-600">
        This same text is available from the Console terminal by typing <code className="rounded bg-white/10 px-1 py-0.5">terms</code>.
      </p>
    </div>
  )
}
